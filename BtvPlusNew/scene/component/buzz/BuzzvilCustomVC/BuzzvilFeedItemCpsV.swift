//
//  BuzzvilFeedItemCpsV.swift
//  BtvPlus
//
//  Created by Youngsoo Park on 2021/06/23.
...
class BuzzvilFeedItemCpsV: BABAdViewHolder, BABNativeAdViewDelegate {
    // MARK: - Outlet
    ...
    private func viewInit() {
        let vc = Bundle.main.loadNibNamed(String(describing: BuzzvilFeedItemCpsV.self), owner: self, options: nil)?.first as? UIView

    ...
    */
    ...
    func postDevicePairing(
        ...
        if let device = device {
            ...
            deviceinfo["stb_mac_address"] = device.stb_mac_address?.toAES(key:NpsNetwork.AES_KEY, iv:NpsNetwork.AES_IV, pass: NpsNetwork.AES_PW)

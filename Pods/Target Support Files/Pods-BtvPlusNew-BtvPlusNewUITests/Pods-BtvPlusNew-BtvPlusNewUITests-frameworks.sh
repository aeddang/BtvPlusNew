...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${PODS_ROOT}/BuzzAd/BuzzAd.framework"
  install_framework "${PODS_ROOT}/BuzzAdBenefit/BuzzAdBenefit.framework"
  install_framework "${PODS_ROOT}/BuzzAdBenefitFeed/BuzzAdBenefitFeed.framework"
  install_framework "${PODS_ROOT}/BuzzAdBenefitInterstitial/BuzzAdBenefitInterstitial.framework"
  install_framework "${PODS_ROOT}/BuzzAdBenefitNative/BuzzAdBenefitNative.framework"
  install_framework "${PODS_ROOT}/BuzzBaseReward/BuzzBaseReward.framework"
  install_framework "${PODS_ROOT}/BuzzConfig/BuzzConfig.framework"
  install_framework "${PODS_ROOT}/BuzzInsight/BuzzInsight.framework"
  install_framework "${PODS_ROOT}/BuzzResource/BuzzResource.framework"
  install_framework "${PODS_ROOT}/BuzzServiceApi/BuzzServiceApi.framework"
  install_framework "${PODS_ROOT}/BuzzUnit/BuzzUnit.framework"

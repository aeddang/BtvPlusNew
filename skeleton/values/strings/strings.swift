...
extension String {
    ...
    struct vs {
        ...
        public static let accountNoMetadata = "vsAccountNoMetadata".loaalized()
        ...
        public static let pairingRequestTvProviderCancel = "vsPairingRequestTvProviderCancel".loaalized()

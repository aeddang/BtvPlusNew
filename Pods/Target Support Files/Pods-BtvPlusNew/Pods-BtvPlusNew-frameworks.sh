...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${PODS_ROOT}/BuzzAdBenefit/BuzzAdBenefitNative.framework"
  install_framework "${PODS_ROOT}/BuzzAdBenefit/BuzzAdBenefitInterstitial.framework"
  install_framework "${PODS_ROOT}/BuzzAdBenefit/BuzzAdBenefitFeed.framework"
  install_framework "${PODS_ROOT}/BuzzAdBenefit/BuzzAdBenefitWebInterface.framework"

...
struct CWGridKids : Codable {
    private(set) var status_code: String? = nil // Kes 연동코드
    private(set) var status_reason: String? = nil // Kes 연동메세지
    private(set) var total_count: Int? = nil // 그리드 개수
    private(set) var menu_stb_svc_id: String? = nil // 서비스코드
    private(set) var grid: [GridsItemKids]? = nil
...
struct GridsItemKids : Codable {
    ...
    private(set) var btrack_id: String? = nil // 블록 트랙 아이디
    init(json: [String:Any]) throws {}
}

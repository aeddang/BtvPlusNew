...
struct Watch : Decodable {
    ...
    private(set) var watch_tot: String? = nil  // 즐겨찾기의 전체 개수
    private(set) var watch_no: String? = nil  // 현재 페이지의 즐겨찾기 개수
    private(set) var yn_ppm: String? = nil // "최근시청VOD조회시 MyBtv/월정액 구분 필수 Y : 월정액 N : My Btv "
...
struct WatchItem : Decodable {
    ...
    private(set) var epsd_rslu_id: String? = nil   // VOD 컨텐트의 해상도ID
    private(set) var yn_series: String? = nil  // 시즌 / 단편(타이틀) 구분, Y(시즌), N(단편)
    private(set) var series_no: String? = nil // VOD 컨텐트의 시리즈 회차
    private(set) var title: String? = nil  // 컨텐트의 이름
    private(set) var level: String? = nil // 사용자 등급
    private(set) var adult: String? = nil  // 성인물 여부  - Y: 성인물, N: 성인물 아님
    private(set) var thumbnail: String? = nil  // 포스터 주소(URL)의 패스 (example=/menu/cate/poster.jpg)
    ...
    private(set) var reg_date: String? = nil   // 시청일 (yy.MM.dd)

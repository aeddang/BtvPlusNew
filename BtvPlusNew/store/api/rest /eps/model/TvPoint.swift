...
struct TvPoint : Decodable {
    ...
    private(set) var tvpoint: TvPointItem? = nil    // TV포인트 정보 ※ API 응답 코드가 '0000'(OK)인 경우에만 응답
}
...
struct  TvPointItem : Decodable {
    ...
    private(set) var url: String? = nil     // TV포인트 연동 URL ※ ui_name에 설정된 URL이 없는 경우 빈값 또는 생략
    private(set) var balance:Double? = nil   // TV포인트 잔액
}
